...
<style>
  .cid-u3GZCsGLCS {
    display: flex;
    background-image: url("images/pond/bg-gif.gif");
  }
</style>
        ...
        <div class="row justify-content-center">
            <div class="item features-image col-12 col-md-6 col-sm-6 col-lg-2">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="images/pond/arduino1.png" data-slide-to="1" data-bs-slide-to="1">
                    </div>
                </div>
            </div>
            <div class="item features-image col-12 col-md-6 col-sm-6 col-lg-2">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="images/pond/mangaldan.png" data-slide-to="2" data-bs-slide-to="2">
                    </div>
                </div>
            </div>
            <div class="item features-image col-12 col-md-6 col-sm-6 col-lg-2">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="images/pond/firebase.png" data-slide-to="3" data-bs-slide-to="3">
                    </div>
                </div>
            </div>
            <div class="item features-image col-12 col-md-6 col-sm-6 col-lg-2">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="images/pond/makerlab.jpg" data-slide-to="4" data-bs-slide-to="4">
                    </div>
                </div>
            </div>
            <div class="item features-image col-12 col-md-6 col-sm-6 col-lg-2">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="images/pond/phinma.png" data-slide-to="5" data-bs-slide-to="5">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-4">
                <div class="col-12 col-md-12">
                    ...
                    <h6 class="mbr-section-subtitle mbr-fonts-style mt-0 mb-4 display-7">
                      Why you should Monitor Water Quality?</h6>                    
                </div>
            </div>
            ...
            <div class="col-lg-8 side-features">
                <div class="item-wrapper align-left">
                    <div class="counter-container mbr-text mbr-fonts-style display-7">
                        <ul>
                        <li>Monitor water quality effectively and ensure a healthier environment for aquatic life.</li>
                        <li>Adopt advanced technology to track pH levels, temperature, dissolved oxygen, and turbidity with precision.</li>
                        <li>Save on costs by utilizing a smart solution for water quality management compared to traditional methods.</li>
                        <li>Help prevent water contamination and maintain sustainable ecosystems.</li>
                        <li>Feel good knowing you've taken proactive steps to safeguard water resources and aquatic habitats.</li>
                        </ul>
                    </div>
                </div>
            </div>
